...
# Set normalization parameter of Planck to DOT
...
# Calculate the respective shares
...
```{r, echo=FALSE}
# Do the same analysis as above but use raw balances.
...
```{r, echo=FALSE}
# If a user voted with a weight of 1 or 0 (to account for both possible votes), their opinion is considered certain. If it is 0.25 or 0.75 it is considered medium and 0.5 is indifferent
